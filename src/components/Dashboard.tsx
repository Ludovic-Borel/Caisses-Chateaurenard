  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pb-5 border-b-2 border-border flex flex-col items-center justify-center min-h-[64px]">
        <h2 className="text-xl font-bold text-primary leading-tight">Tableau de bord</h2>
        <p className="text-base text-muted-foreground leading-tight mt-1.5">{MONTH_NAMES[currentData.month]} {currentData.year}</p>
      </div>
