...
export const DEFAULT_DRIVERS = [
  ...
  "BEC", "BELHAJ", "BENRAHHOU", "BENRAHOU", "BENZEROUK",
  "BENZERROUK", "BERNARAS", "BOREL", "BOUBAKRI", "BOUSSARIE",
  "CALATAYUD", "CAMPOS", "CHAKOR", "CHAMANIER", "CHAMBRON",
  "CHAROUITE", "CHAVOUTIER", "CHOPIN", "CHOUANE", "CHOUHANE",
  "DJAHMI", "DRID", "DUMONT", "EL BADRI", "ESPOSITO",
  "FARE", "FATIHI", "FILIPE", "GHRIB", "GILLES",
  "GOZIN", "GUILLOT", "HAJJI", "ISOARDO", "JUAN",
  "LACOMBE", "LE BIGOT", "M'HAYA", "MACHABERT", "MAFFEI",
  "MANFRINI", "MARCON", "MARTINEZ", "MEYER", "MSELLI",
  "PALOMARES", "PANAROTTO", "PREAUX A", "RAKOTOMAMONJY", "RASCOL",
  "REY J", "REY M", "REY T", "ROLLAND", "STANGHELLINI",
  "SYLVESTRE", "TANNOUCH", "THOMASSIN"
];